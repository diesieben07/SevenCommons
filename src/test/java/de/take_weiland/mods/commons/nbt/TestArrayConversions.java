...
import static de.take_weiland.mods.commons.nbt.ArrayConversions.dZ;
import static de.take_weiland.mods.commons.nbt.ArrayConversions.eZ;
...
public class TestArrayConversions {
	...
	public void testEncodeBooleans() throws Exception {
		...
		assertThat(eZ(data), is(expected));
	}
	...
	public void testDecodeBooleans() {
		...
		assertThat(dZ(data),	is(expected));
	}
}