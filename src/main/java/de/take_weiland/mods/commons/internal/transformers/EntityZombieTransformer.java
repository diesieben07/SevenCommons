...
import static de.take_weiland.mods.commons.asm.MCPNames.M_CONVERT_TO_VILLAGER;
...
public final class EntityZombieTransformer implements ASMClassTransformer {
	...
	public boolean transform(ClassNode clazz, ClassInfo classInfo) {
		MethodNode method = ASMUtils.requireMinecraftMethod(clazz, M_CONVERT_TO_VILLAGER);
