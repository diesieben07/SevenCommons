...
public final class DefaultNBTSerializers implements NBTSerializerFactory {
    // TODO
    @Override
    public <T> NBTSerializer<?> get(Property<T> property) {
        return null;
    }
...
//    }
//
//    private enum ForBool implements NBTSerializer.Value<Boolean> {
//        INSTANCE;
//
...
//    }
//
//    private enum ForByte implements NBTSerializer.Value<Byte> {
//        INSTANCE;
//
//        @Override
...
//    }
//
//    private enum ForShort implements NBTSerializer.Value<Short> {
//        INSTANCE;
//
//
//        @Override
...
//    }
//
//    private enum ForChar implements NBTSerializer.Value<Character> {
//
//        INSTANCE;
//
//        @Override
...
//    }
//
//    private enum ForInt implements NBTSerializer.Value<Integer> {
//        INSTANCE;
//
//        @Override
...
//    }
//
//    private enum ForLong implements NBTSerializer.Value<Long> {
//
//        INSTANCE;
//
//        @Override
...
//    }
//
//    private enum ForFloat implements NBTSerializer.Value<Float> {
//
//        INSTANCE;
//
//        @Override
...
//    }
//
//    private enum ForDouble implements NBTSerializer.Value<Double> {
//
//        INSTANCE;
//
//        @Override
...
//    }
//
//    private enum ForCharSeq implements NBTSerializer.Value<CharSequence> {
//
//        INSTANCE;
//
//        @Override
...
//    }
//
//    private enum ForItemStack implements NBTSerializer.Value<ItemStack> {
//
//        INSTANCE;
//
//        @Override
...
//    }
//
//    private enum ForFluidStack implements NBTSerializer.Value<FluidStack> {
//
//        INSTANCE;
//
//        @Override
