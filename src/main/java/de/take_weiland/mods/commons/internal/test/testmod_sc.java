...
//                .register(0, (PacketConstructor<TestPacket>) TestPacket::new, (PacketConstructor<TestResponse>) TestResponse::new, (PacketHandler.WithResponse.WithSideAndPlayer<TestPacket, TestResponse>) (packet, side, byte side, NetworkManager manager) -> new TestResponse(packet.s))
//                .build();
//
