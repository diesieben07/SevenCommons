...
import de.take_weiland.mods.commons.internal.sync_olds.ChangedValue;
 ...
 * @author diesieben07
 */
public interface TypeSyncer<VAL, COM, DATA> {
     ...
     */
    interface ForImmutable<VAL> extends TypeSyncer<VAL, VAL, VAL> {
