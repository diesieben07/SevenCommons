...
public final class Constants {
	...
	public static final int CLOTH_LIGHT_BLUE = 3;
	public static final int CLOTH_YELLOW = 4;
	public static final int CLOTH_LIME = 5;
	public static final int CLOTH_PINK = 6;
	public static final int CLOTH_GRAY = 7;
	public static final int CLOTH_LIGHT_GRAY = 8;
	public static final int CLOTH_CYAN = 9;
	public static final int CLOTH_PURPLE = 10;
	public static final int CLOTH_BLUE = 11;
	public static final int CLOTH_BROWN = 12;
