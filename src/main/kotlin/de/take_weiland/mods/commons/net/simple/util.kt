 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(vararg players: EntityPlayer): M {
    return sendMulti {
 ...
 * Send this packet to the given players.
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(vararg players: EntityPlayerMP): M {
    return sendMulti {
        for (player in players) {
            sendTo(player)
        }
 ...
 */
inline fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(vararg players: EntityPlayer, filter: (EntityPlayerMP) -> Boolean): M {
    return sendMulti {
        for (player in players) {
 ...
 * Send this packet to the players in the list that match the given filter.
 */
inline fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(vararg players: EntityPlayerMP, filter: (EntityPlayerMP) -> Boolean): M {
    return sendMulti {
        for (player in players) {
 ...
 * Send this packet to the given players.
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(players: Iterable<EntityPlayer>): M {
...
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(players: Iterable<EntityPlayerMP>): M {
    return sendTo(players.iterator())
}
 ...
 * Send this packet to the players in the list that match the given filter.
 */
inline fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(players: Iterable<EntityPlayer>, filter: (EntityPlayerMP) -> Boolean): M {
 ...
 */
@JvmName("sendToPlayersMP")
inline fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(players: Iterable<EntityPlayerMP>, filter: (EntityPlayerMP) -> Boolean): M {
    return sendTo(players.iterator(), filter)
}
 ...
 * Send this packet to the given players.
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(players: Iterator<EntityPlayer>): M {
    return sendMulti {
 ...
 */
@JvmName("sendToPlayersMP")
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(players: Iterator<EntityPlayerMP>): M {
    return sendMulti {
 ...
 */
inline fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(players: Iterator<EntityPlayer>, filter: (EntityPlayerMP) -> Boolean): M {
    return sendMulti {
        for (player in players) {
            (player as EntityPlayerMP).let {
                if (filter(it)) sendTo(it)
 ...
 */
@JvmName("sendToPlayersMP")
inline fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(players: Iterator<EntityPlayerMP>, filter: (EntityPlayerMP) -> Boolean): M {
    return sendMulti {
        for (player in players) {
            if (filter(player)) sendTo(player)
        }
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToTrackingChunk(world: World, chunkX: Int, chunkZ: Int): M {
 ...
 * Send this packet to all players tracking the chunk with the given coordinates.
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToTrackingChunk(world: WorldServer, chunkX: Int, chunkZ: Int): M {
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToTracking(chunk: Chunk): M {
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToTracking(tileEntity: TileEntity): M {
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToTracking(entity: Entity): M {
 ...
 * player itself.
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToAllAssociated(entity: Entity): M {
    return sendMulti {
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToAllAssociated(entity: EntityPlayer): M {
 ...
 * Send this packet to all players tracking the given player entity and the player itself.
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToAllAssociated(entity: EntityPlayerMP): M {
    return sendMulti {
        sendTo(entity.trackingPlayers)
        sendTo(entity)
    }
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToTracking(container: Container): M {
    return sendMulti {
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToAll(): M {
 ...
 */
inline fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(filter: (EntityPlayerMP) -> Boolean): M {
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(world: World): M {
 ...
 * Send this packet to all players in the given world.
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(world: WorldServer): M {
 ...
 */
inline fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(world: World, filter: (EntityPlayerMP) -> Boolean): M {
 ...
 * Send this packet to all players in the given world that match the given filter.
 */
inline fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendTo(world: WorldServer, filter: (EntityPlayerMP) -> Boolean): M {
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToNear(world: WorldServer, x: Double, y: Double, z: Double, radius: Double): M {
 ...
 * Send this packet to all players within the given radius of the given coordinates.
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToNear(world: WorldServer, pos: Vec3i, radius: Double): M {
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToNear(tileEntity: TileEntity, radius: Double): M {
 ...
 */
fun <R, M, B : MultiResultBuilder<M, B>> Sendable<R, M, B>.sendToNear(entity: Entity, radius: Double): M {
